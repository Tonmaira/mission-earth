      ...
      <div className="relative z-10 w-full max-w-md py-10">
        ...
        <div className="border border-[#CEA870]/20 rounded-3xl bg-[#001f33]/80 backdrop-blur-md px-8 py-10 shadow-2xl">
          ...
          <p className="text-center text-gray-500 text-sm">
            ...
            <a href={path("/login")} className="text-[#CEA870] hover:underline">Sign in</a>
          </p>
        </div>

        {/* Back */}
        <div className="flex justify-center mt-6">
          <a href={path("/")} className="text-gray-600 text-xs hover:text-[#CEA870] transition-colors flex items-center gap-2">
