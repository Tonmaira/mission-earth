      ...
      <div className="w-full max-w-5xl bg-[#052032] rounded-[20px] overflow-hidden flex flex-col md:flex-row min-h-[580px]">
        ...
        <div className="relative w-full md:w-[42%] h-56 md:h-auto shrink-0 overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-between p-7">
            <a href={path("/")}><Image src="/full-logo-me.svg" alt="Mission Earth" width={100} height={32} className="object-contain" /></a>
          ...
          {step === TOTAL_Q + 1 && (
            <div className="flex flex-col gap-6 overflow-y-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <a href={path("/contact")} className="flex-1 text-center border border-[#CEA870] text-[#CEA870] py-3 rounded-full text-sm font-semibold hover:bg-[#CEA870] hover:text-[#002740] transition-all">
                  ปรึกษาผู้เชี่ยวชาญ
                </a>
