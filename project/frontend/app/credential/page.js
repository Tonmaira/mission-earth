...
import PreparedForProvider from "@/components/credential/preparedFor";
...
export default function CredentialPage() {
  return (
    /*
      The client name rides in the URL: /credential is the generic deck and
      /credential?for=<name> puts a name on every slide. `useSearchParams` needs
      a Suspense boundary around it on a prerendered page, which is all this is.
    */
    <Suspense>
      <PreparedForProvider>
        <DeckShell>
